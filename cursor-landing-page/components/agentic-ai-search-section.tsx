  ...
  return (
    <div className="my-24">
      ...
      <div className="text-center mb-6 md:mb-12 px-4">
        <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none text-foreground mb-4">
          Agentic AI Search
        </h2>
        <p className="max-w-2xl mx-auto text-[15px] text-muted-foreground font-light text-center">
