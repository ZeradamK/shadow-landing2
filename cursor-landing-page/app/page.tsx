...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-black pt-24 text-white font-geist">
      {/* Navigation */}
      <Navbar />
      ...
      <div className="max-w-[1920px] mx-auto relative px-6 md:px-8">
        {/* Hero Section */}
        <section className="relative rounded-[16px] rounded-all-devices mt-6 mb-6 md:h-[calc(100vh-144px)] font-geist text-white flex flex-col">
        ...
        <section className="pb-12 md:pb-16 bg-black mt-[60px] md:mt-[112px]">
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-y-8 sm:gap-y-12 gap-x-4 mb-8 md:mb-12 max-w-4xl mx-auto">
              <CompanyName name="Windsurf" />
              <CompanyName name="VS Code" />
              <CompanyName name="Cursor" />
              <CompanyName name="Manus AI" />
              <CompanyName name="Trae" className="sm:hidden md:block" />
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-8 sm:gap-y-12 gap-x-4 max-w-md mx-auto">
